...
public class MeterServlet extends HttpServlet {
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		pw.println("<tr><th>CustomerName</th><th>CustomerId</th><th>MeterNo</th><th>Units</th><th>DiscountAmount</th></tr>");
		
		pw.println("<tr><td>"+mb.getCustName()+"</td><td>"+mb.getCustomerIdc()+"</td><td>"+mb.getMeterNoc()+"</td><td>"+mb.getMeterReadingc()+"</td><td>"+mb.getDiscountAmount()+"</td></tr>");
		pw.println("</table>");
		//close the stream
		pw.close();
	}
